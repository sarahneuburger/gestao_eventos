...
public class TelaCadastrarSala extends JFrame {
	...
	public TelaCadastrarSala() {
		setIconImage(
				Toolkit.getDefaultToolkit().getImage(TelaCadastrarSala.class.getResource("/img/imgTelaInicial3.png")));
		...
		baseCadastrarSalas.setLayout(new FormLayout(
				new ColumnSpec[] { ColumnSpec.decode("10dlu"), ColumnSpec.decode("58dlu"), ColumnSpec.decode("140dlu"),
						ColumnSpec.decode("40dlu"), },
				new RowSpec[] { RowSpec.decode("10dlu"), RowSpec.decode("30dlu:grow"), RowSpec.decode("12dlu"),
						RowSpec.decode("default:grow"), RowSpec.decode("12dlu"), RowSpec.decode("default:grow"),
						RowSpec.decode("12dlu"), RowSpec.decode("default:grow"), RowSpec.decode("12dlu:grow"), }));
